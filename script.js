      ...
      <div class="grid grid-2">
        ...
        <div class="tool-panel reveal">
          ...
          <ul style="display:flex;flex-direction:column;gap:14px;font-size:13.5px;color:var(--text-2);">
            ...
            <li><b style="color:var(--text-1);">Buying Epic Cards in the shop.</b>You can buy epic cards with coins in the shop as long as you have at least 500k coins and trade 40 epic cards into two legendary cards. </li>
